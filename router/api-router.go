	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		tokenRoute := apiRouter.Group("/token")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/search", middleware.SearchRateLimit(), controller.SearchTokens)
				...
				selfRoute.POST("/batch", controller.DeleteTokenBatch)
			}
		...
		logRoute.GET("/user", middleware.AdminAuth(), controller.GetUserIdLogs)
